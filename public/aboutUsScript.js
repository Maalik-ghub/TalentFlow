...
const v5v1h2v2btn1 = document.querySelector(".v5-v1-h2-v2-btn1");
const v5v1h2v2btn2 = document.querySelector(".v5-v1-h2-v2-btn2");
const v5v1h2v2btn3 = document.querySelector(".v5-v1-h2-v2-btn3");
const v5v1h2v2btn4 = document.querySelector(".v5-v1-h2-v2-btn4");
const v5v1h2v2btn5 = document.querySelector(".v5-v1-h2-v2-btn5");
const v5v1h2v2btn6 = document.querySelector(".v5-v1-h2-v2-btn6");

const v5v1h2v3btn1 = document.querySelector(".v5-v1-h2-v3-btn1");
const v5v1h2v3btn2 = document.querySelector(".v5-v1-h2-v3-btn2");
const v5v1h2v3btn3 = document.querySelector(".v5-v1-h2-v3-btn3");

const v5v1h3v2inp1 = document.querySelector(".v5-v1-h3-v2-inp1");
const v5v1h3v3btn1 = document.querySelector(".v5-v1-h3-v3-btn1");
...
v5v1h2v2btn1.addEventListener("click", () => {
    document.location.href = "/"
})

v5v1h2v2btn2.addEventListener("click", () => {
    document.location.href = "/about"
})

v5v1h2v2btn3.addEventListener("click", () => {
    document.location.href = "/care"
})

v5v1h2v2btn4.addEventListener("click", () => {
    document.location.href = "/staffing"
})

v5v1h2v2btn5.addEventListener("click", () => {
    document.location.href = "/business"
})

v5v1h2v2btn6.addEventListener("click", () => {
    document.location.href = "/contact"
})

v5v1h2v3btn1.addEventListener("click", () => {
    document.location.href = "#facebook"
})

v5v1h2v3btn2.addEventListener("click", () => {
    document.location.href = "#x"
})

v5v1h2v3btn3.addEventListener("click", () => {
    document.location.href = "#insta"
})
...
v5v1h3v3btn1.addEventListener("click", () => {
    if(isNaN(v5v1h3v2inp1.value) || v5v1h3v2inp1.value.length < 7 || v5v1h3v2inp1.value.length > 18) {
        ...
        body = {
            number: v5v1h3v2inp1.value
           }
        requestUtils("POST", "/callme", JSON.stringify(body))
        v5v1h3v2inp1.value = null;
        v5v1h3v2inp1.placeholder = "Successfully Sent";
    }
})
